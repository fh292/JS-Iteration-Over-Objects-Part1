...
/******************************
  ...
  ********************************/
const movieCount = movies.reduce((accumulator, movie) => {
  const year1994 = movie.year === 1994;
  const total = accumulator + year1994;
  return total;
}, 0);
...
/******************************
  ...
  ********************************/
function updateGenre(title) {
  if (title === "The Dark Knight") movies[3].genre = "Action/Drama";
  return movies;
}
console.log(updateGenre("The Dark Knight"));
